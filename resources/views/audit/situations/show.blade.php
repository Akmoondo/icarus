...
<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method ="POST" action="{{ route('audit.situations.update', $situations->uuid) }}" > 
    ...
    <div class="form-group">
        ...
        <input  type="text" id="situation" name="situation" required="required" class="form-control col-md-7 col-xs-12" value="{{$situations->situation}}">
        </div>
    </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Cor<span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="color" name="color" required="required" class="form-control col-md-7 col-xs-12" value="{{$situations->color}}">
            </div>
        </div>
